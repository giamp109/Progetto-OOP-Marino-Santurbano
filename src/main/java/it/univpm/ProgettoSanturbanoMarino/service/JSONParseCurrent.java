...
*
* La classe JSONParseCurrent mette a disposizione il metodo per effettuare il parsing del JSONObject preso tramite la chiamata all'API Current Weather Data.
* 
*/
public class JSONParseCurrent {
	...
	/**
	*
	* Il metodo 'ParseCity()' effettua la chiamata all'API tramite il metodo 'getForecastCurrent()' della classe 'WeatherDatabaseCurrent' e effettua
	* il parsing delle informazioni creando un oggetto di tipo City.
	*
	* @param cityname rappresenta la città di cui si vuole conoscere le previsioni meteo
